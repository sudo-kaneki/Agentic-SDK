...
class EnergyAdvisor:
    ...
    def get_advice(self, usage_data: dict) -> str:
        ...
        return f"Based on your total usage of {total_usage} kWh, focusing on {highest_usage[0]} " \
...
async def demonstrate_unified_observability():
    ...
    response = "Based on average home energy usage, you could save approximately 25% on your " \
    ...
    with observability.start_span("tool.calculate_energy_savings", tool_name="calculate_energy_savings") if observability else nullcontext():
