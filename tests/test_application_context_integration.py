...
class TestApplicationContextIntegration:
    ...
    def app_with_context(self, mock_context_store_client):
        ...
        app = EnergyAIApplication(
            title="Test App",
            context_store_client=mock_context_store_client
        )
        return app
    ...
    async def test_chat_request_context_store_error_handling(self, app_with_context):
        ...
        app_with_context.context_store_client.load_or_create.side_effect = Exception("Cosmos DB error")
    ...
    def test_session_management_endpoints_context_store_available(self, app_with_context):
        ...
        session_doc = app_with_context.context_store_client.load_or_create("test_session", "test_user")
        assert session_doc is not None
        
        # Test getting conversation history
        history = app_with_context.context_store_client.get_conversation_history("test_session", "test_user")
    ...
    def test_conversation_history_formatting(self, app_with_context):
        ...
        thread = [
            ...
            {'sender': 'agent', 'content': 'Hi there!', 'agent_name': 'Assistant', 'timestamp': '2024-01-01T12:00:05Z'},
